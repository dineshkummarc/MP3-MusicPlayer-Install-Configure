...
<%--               </div>--%>
            ...
            <ajaxToolkit:CollapsiblePanelExtender ID="fileExplorerCollapsiblePanelExtender" runat="server" 
        ...
        <td nowrap="nowrap" valign="top" align="center">
            <table width="100%">
                <tr>
                    ...
                    <td align="right">
                        SKIN:<asp:DropDownList ID="skinDropDownList" runat="server" AutoPostBack="True" OnSelectedIndexChanged="skinDropDownList_SelectedIndexChanged">
                        </asp:DropDownList>
                    </td>
                </tr>
            </table>
...
<%--    <param name="movie" value="Player/xspf_player.swf?playlist_url=/DebugLists/Bad.xspf&xn_auth=no&autoload=true" />--%>
    ...
    <tr>
        <td align="center" colspan="2" nowrap="nowrap" valign="top">
            ...
            UltiDev <a href="http://ultidev.com/Products/httpvpn/" target="_blank">HttpVPN™</a>, UltiDev <a href="http://ultidev.com/products/cassini/" target="_blank"> Cassini Web Server for ASP.NET 2.0 and 3.x</a><br />
