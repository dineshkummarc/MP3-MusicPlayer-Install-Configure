...
public class CoverArt : IHttpHandler 
{
    ...
    public void ProcessRequest(HttpContext context)
    {
        ...
        if(this.Request.QueryString.Count > 0)
            songFilePath = this.Request.QueryString[0];
        ...
        this.Response.Redirect(string.Format("{0}/Images/NoCoverArt.jpg", this.Request.ApplicationPath.TrimEnd('/')));
    }
